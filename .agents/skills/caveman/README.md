...
Project default: `lite`, enforced by root `AGENTS.md`.
...
| `full` | Heavier compression. Drop articles, fragments OK, short synonyms. |
...
```
/caveman lite         # project default
/caveman full         # heavier compression
